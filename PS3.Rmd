...
```
**Interpretation:**
When the interaction term is negligible (β₃ ≈ 0), ignoring it does not significantly affect prediction accuracy. However, when the interaction effect is substantial (β₃ = 3.1), the naive model exhibits considerably higher MSE, demonstrating the cost of model misspecification.
